    ...
    <section id="privacy-info-con" class="grid-con dm">
        ...
        <div id="privacy-info" class="col-span-full">
            <ul>
                ...
                <li><span class="privacy-title">Links To Other Websites:</span><br>This website may contain links that redirect to other websites that are not covered by this privacy policy.</li>
                <li><span class="privacy-title">Advertising:</span><br>Fandom PokePartners does not intend to use any form of advertising services within the website. We do not collect personal data for advertising purposes. In the event of a change, this policy will be updated and a prominent notice of these changes will be displayed to encourage users to review.</li>
                <li><span class="privacy-title">Contact Information:</span><br>For any inquiries or concerns regarding this Privacy Policy, the use of Fandom PokePartners, or if you have concerns about how your data is being handled, please contact us through our <a class="privacy-link" href="contact.php">contact page</a>.<br>
                By using Fandom PokePartners, you agree to adhere to the terms outlined in this Privacy Policy. If you do not agree with our policies and practices, please do not register or submit any information to the website.<br>If you believe an account has been created by a user under the age of 13, please contact us immediately so appropriate action can be taken.</li>
