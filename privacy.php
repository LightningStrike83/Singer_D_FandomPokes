    ...
    <section id="privacy-info-con" class="grid-con dm">
        ...
        <div id="privacy-info" class="col-span-full">
            <ul>
                ...
                <li><span class="privacy-title">Cookies, Tracking, and Storage:</span><br>Fandom PokePartners does not use cookies or tracking for any of the features found within the website.<br> SessionStorage is used solely to verify if a user has agreed to rules for submitting to the database. No other instance of SessionStorage is used throughout the site or for any other purpose.<br>LocalStorage is only used for two purposes in this website and is not used for any other purpose or saves any information aside from the purposes listed below:<br>-To save the user's preference for Light or Dark mode<br>-To prevent the startup message from reappearing on subsequent visits</li>
